...
const Footer = () => {
  return (
    ...
    <p className='py-4 text-center text-xs md:text-sm text-white/60'>
      Copyright 2025 DominatorsLMS. All Rights Reserved.<br/>
       <span className='text-yellow-500 text-12xl'>Built and Developed by Omkar Kudalkar and Vansh Patil</span>
    </p>
  </footer>
  )
}
